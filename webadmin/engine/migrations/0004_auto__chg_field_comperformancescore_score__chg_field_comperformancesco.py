...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComperformanceScore.score'
        db.alter_column(u'comperformancescore', 'score', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'ComperformanceScore.assessmentscore'
        db.alter_column(u'comperformancescore', 'assessmentscore', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'ComperformanceScore.score'
        db.alter_column(u'comperformancescore', 'score', self.gf('django.db.models.fields.FloatField')(default=1))

        # Changing field 'ComperformanceScore.assessmentscore'
        db.alter_column(u'comperformancescore', 'assessmentscore', self.gf('django.db.models.fields.FloatField')(default=1))
