...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComperformanceDevelopmentScore.score'
        db.alter_column(u'comperformancedevelopmentscore', 'score', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'ComperformancePhysicalScore.score'
        db.alter_column(u'comperformancephysicalscore', 'score', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'ComperformanceBehaviorScore.score'
        db.alter_column(u'comperformancebehaviorscore', 'score', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'ComperformanceDevelopmentScore.score'
        db.alter_column(u'comperformancedevelopmentscore', 'score', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'ComperformancePhysicalScore.score'
        db.alter_column(u'comperformancephysicalscore', 'score', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'ComperformanceBehaviorScore.score'
        db.alter_column(u'comperformancebehaviorscore', 'score', self.gf('django.db.models.fields.FloatField')(default=0))
    ...
    models = {
        ...
        'engine.comperformancescore': {
            ...
            'assessmentscore': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'comperformance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['engine.Comperformance']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'score': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['engine.Student']"})
